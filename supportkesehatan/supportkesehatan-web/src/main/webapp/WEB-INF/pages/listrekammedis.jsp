...
<head>
  ...
  <title> Rekam Medis | Sistem Jaminan Kesehatan</title>
...
<section class="title">
    ...
    <section id="contact-page" class="container">
      ...
      <h1><i class="icon-file icon-big"></i> Daftar Riwayat Rekam Medis <i class="icon-file icon-big"></i>  </h1>
    </div>
        <div class="row-fluid">
           ...
           <table class="table table-hover table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th style="text-align:center;width:50%;">Diagnosa</th>
                  <th style="text-align:center;width:10%;">Oleh</th>
